        ...
        return (
            <section className="bg-black min-h-screen pt-32 px-5 md:px-10 pb-10 w-screen overflow-x-hidden flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-4xl md:text-6xl font-zentry text-blue-50 mb-4">Article Not Found</h1>
                    <button
    ...
    return (
        <section className="bg-black min-h-screen pt-32 px-5 md:px-10 pb-10 w-screen overflow-x-hidden">
            ...
            >
                ...
                <span className="font-circular-web">Back to Articles</span>
            </button>
            ...
            <div className="max-w-6xl mx-auto">
                ...
                {/* Title and Meta */}
                <div className="mb-12">
                    <h1 className="text-5xl md:text-7xl font-zentry text-blue-50 mb-4 uppercase leading-none">{article.title}</h1>
                    <div className="flex flex-wrap gap-6 text-blue-50/70 font-circular-web text-lg">
                        ...
                        <div>
                            ...
                            <p className="font-semibold capitalize">{article.generate}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-1">
                        ...
                        {hasResources && (
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                <h3 className="text-xl font-zentry text-blue-50 mb-4 uppercase">
                                    Project Resources
                                </h3>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {article.linkVideo && (
                                        <div>
                                            <p className="text-blue-50/50 text-sm font-circular-web mb-1">Video</p>
                                            <a
                                                href={article.linkVideo}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="text-blue-100 underline font-circular-web hover:text-white transition-colors break-all"
                                            >
